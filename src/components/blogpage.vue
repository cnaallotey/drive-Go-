  ...
  <div>
    ...
    <div class="w-full max-w-screen-xl px-4 mx-auto mt-10 lg:mt-10">
      ...
      <div class="max-w-screen-xl mx-auto mt-5">
        <p class="text-base font-normal text-gray-700 leading-5 max-w-xl">
          {{ blog["post-summary"] }}
        </p>
      ...
      <div class="w-full flex flex-col lg:flex-row lg:space-x-10">
        <div class="max-w-screen-md mx-0 mt-5">
          <div
            class="text-gray-700 text-lg space-y-4 col-span-3 blog"
            id="blog"
            v-html="blog['post-body']"
          ></div>
          <div class="w-full space-x-2 items-center mb-10 flex flex-wrap">
          ...
          <div class="col-span-3 lg:col-span-2">
            <div class="w-full relative">
              <div
                class="w-fit mx-auto rounded-2xl bg-opacity-100 p-5 px-10 bg-slate-100 flex flex-col items-center space-y-3"
              >
